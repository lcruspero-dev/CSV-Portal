...
const TeamExpectationsAcknowledgement: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-100 py-10 flex flex-col items-center gap-10">
      {/* ================= DOCUMENT 1 ================= */}

      <DocumentPage>
        <div className="space-y-2 mb-8">
          <LineField label="EMPLOYEE NAME:" />
          <LineField label="POSITION:" />
      ...
      <DocumentPage>
        <Section title="ADAPTABILITY AND CHANGE">
          <p className="leading-6 mb-4">
            ...
            levels, schedules, responsibilities, workflows, and team structures
      ...
      <DocumentPage>
        ...
        <p className="leading-6 mb-10">
          My signature confirms receipt and understanding of these expectations.
          It does not alter my employment status or any existing company
          policies.
        </p>

        {/* INPUT SIGNATURE FORM */}

        <div className="w-[450px] border border-gray-300 text-[11px]">
          <div className="grid grid-cols-[140px_1fr]">
            ...
            <div className="border-b border-gray-300 p-2">
              <Input className="border-0 shadow-none h-6" />
            </div>
            ...
            <div className="border-r border-gray-300 font-bold p-2">Date:</div>
...
const LineField = ({ label }: { label: string }) => (
  <div className="flex items-center gap-2">
    <b className="w-[120px]">{label}</b>

    <Input className="border-0 border-b rounded-none shadow-none h-6" />
  </div>
);
